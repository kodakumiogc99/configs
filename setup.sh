...
execute 'curl -LO https://github.com/BurntSushi/ripgrep/releases/download/13.0.0/ripgrep_13.0.0_amd64.deb'
execute 'dpkg -i ripgrep_13.0.0_amd64.deb'
execute 'rm -rf ripgrep_13_13.0.0_amd64.deb'
execute 'apt install openssh-server'
execute 'ssh-keyscan -H github.com >> ~/.ssh/known_hosts'
